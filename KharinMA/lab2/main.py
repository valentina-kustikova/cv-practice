...
from yolo_v3 import YoloV3CocoDetector
...
MODEL_CONFIGS = {
    ...
    "yolo_v4_coco": {
        ...
        "config": "models/yolov4/yolov4-tiny.cfg",
        "classes": "models/yolov4/coco.names",
    },
    "yolo_v3_coco": {
        "model": "models/yolov3/yolov3-tiny.weights",
        "config": "models/yolov3/yolov3-tiny.cfg",
        "classes": "models/yolov3/coco.names",
    },
}
...
def main():
    ...
    for frame_id, image, gt_boxes in reader:
        ...
        if args.show:
            ...
            key = cv2.waitKey(1)
            if key == 27 or cv2.getWindowProperty("Обнаружение", cv2.WND_PROP_VISIBLE) < 1:  # Esc или крестик
                break
