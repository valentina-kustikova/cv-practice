...
class YoloV3CocoDetector(BaseDetector, model_name="yolo_v3_coco"):
    """
    Детектор на основе YOLOv3-tiny.
    Легковесная и быстрая модель для детектирования объектов.
    """
    ...
    def __init__(
        ...
        # YOLOv3-tiny использует вход 416x416
