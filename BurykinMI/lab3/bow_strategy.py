...
# ============================================================================
# Реализует стратегию классификации Bag of Words (BoW) + SVM.
# Основные этапы:
# 1. Построение словаря визуальных слов через кластеризацию (MiniBatchKMeans)
# 2. Преобразование изображений в гистограммы слов (BoW-представление)
# 3. Обучение SVM-классификатора на BoW-признаках
# Поддерживает сохранение/загрузку обученной модели через pickle.
# ============================================================================
