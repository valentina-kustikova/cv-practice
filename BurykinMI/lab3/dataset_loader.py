...
# ============================================================================
# Отвечает за загрузку и подготовку датасета достопримечательностей.
# - Читает изображения из директорий ExtDataset и NNSUDataset
# - Выполняет маппинг папок на классы (kremlin, cathedral, palace)
# - Разделяет данные на train/test согласно файлу train.txt
# - Выводит статистику распределения классов по выборкам
# ============================================================================
