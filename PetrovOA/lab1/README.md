...
**Принцип работы:**
Готовая текстура блика накладывается на изображение
...
**Алгоритм:**
Накладывает текстуру, имитирующую неровности акварельной бумаги.

**Принцип работы:**
Готовая текстура акварельной бумаги накладывается на изображение
