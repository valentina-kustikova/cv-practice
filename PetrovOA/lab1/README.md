...
- Веккторные и матричные операции для обработки пикселей
...
```
lab1/
├── main.py                 # Основной скрипт с реализацией фильтров
├── demo_filters.py         # Скрипт для демонстрации всех фильтров
├── create_test_image.py    # Создание тестового изображения
├── examples.txt            # Примеры команд для всех фильтров
...
Проект создан в учебных целях в рамках курса компьютерного зрения.
