...
class NanoDet(BaseDetector):
    def __init__(self, modelPath, probThreshold=0.35, iouThreshold=0.6, backendId=0, targetId=0):
    ...
    def postprocess(self, preds):
        ...
        indices = cv2.dnn.NMSBoxes(bboxes_wh.tolist(), confidences.tolist(), self.probThreshold, self.iouThreshold)
