...
class Detector:
    ...
    def detect_objects(self, image, net, classes, layers, colors):
        ...
        return class_ids, probabilities, boxes

    def draw_rectangles(self, image, classes, colors, class_ids, probabilities, boxes):
    ...
    def process_image(self, net, classes, layers, colors):
        ...
        class_ids, probabilities, boxes = self.detect_objects(image, net, classes, layers, colors)
        output_img, objects_count = self.draw_rectangles(image, classes, colors, class_ids, probabilities, boxes)
    ...
    def process_video(self, net, classes, layers, colors):
        ...
        while True:
            ...
            class_ids, probabilities, boxes = self.detect_objects(frame, net, classes, layers, colors)
            output_frame, objects_count = self.draw_rectangles(frame, classes, colors, class_ids, probabilities, boxes)
